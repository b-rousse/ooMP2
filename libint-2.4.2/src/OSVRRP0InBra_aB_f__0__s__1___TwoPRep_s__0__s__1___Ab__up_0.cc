...
fp2 = libint2::fma_minus(inteval->roz[vi], src3[((hsi*3+2)*1+lsi)*1], src2[((hsi*3+2)*1+lsi)*1]);
...
fp17 = libint2::fma_minus(inteval->roz[vi], src3[((hsi*3+1)*1+lsi)*1], src2[((hsi*3+1)*1+lsi)*1]);
...
fp19 = libint2::fma_plus(inteval->PA_y[vi], src0[((hsi*6+3)*1+lsi)*1], fp20);
...
fp26 = libint2::fma_plus(inteval->PA_z[vi], src0[((hsi*6+1)*1+lsi)*1], fp27);
...
fp37 = libint2::fma_plus(inteval->PA_y[vi], src0[((hsi*6+0)*1+lsi)*1], fp38);
