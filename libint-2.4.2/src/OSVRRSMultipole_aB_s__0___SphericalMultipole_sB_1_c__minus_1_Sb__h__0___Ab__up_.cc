...
fp24 = -5.0000000000000000e-01 * src2[((hsi*15+10)*1+lsi)*1];
...
fp28 = libint2::fma_plus(inteval->PB_z[vi], src0[((hsi*15+9)*1+lsi)*1], fp29);
...
fp33 = libint2::fma_plus(inteval->PB_z[vi], src0[((hsi*15+8)*1+lsi)*1], fp34);
...
fp38 = libint2::fma_plus(inteval->PB_z[vi], src0[((hsi*15+7)*1+lsi)*1], fp39);
target[((hsi*21+12)*1+lsi)*1] = fp38;
LIBINT2_REALTYPE fp43;
fp43 = inteval->PB_z[vi] * src0[((hsi*15+6)*1+lsi)*1];
target[((hsi*21+11)*1+lsi)*1] = fp43;
LIBINT2_REALTYPE fp47;
fp47 = -5.0000000000000000e-01 * src2[((hsi*15+6)*1+lsi)*1];
...
fp44 = libint2::fma_plus(inteval->PB_y[vi], src0[((hsi*15+6)*1+lsi)*1], fp45);
...
fp51 = libint2::fma_plus(inteval->PB_z[vi], src0[((hsi*15+5)*1+lsi)*1], fp52);
...
fp56 = libint2::fma_plus(inteval->PB_z[vi], src0[((hsi*15+4)*1+lsi)*1], fp57);
target[((hsi*21+8)*1+lsi)*1] = fp56;
LIBINT2_REALTYPE fp61;
fp61 = inteval->PB_z[vi] * src0[((hsi*15+3)*1+lsi)*1];
target[((hsi*21+7)*1+lsi)*1] = fp61;
LIBINT2_REALTYPE fp65;
fp65 = -5.0000000000000000e-01 * src2[((hsi*15+3)*1+lsi)*1];
...
fp62 = libint2::fma_plus(inteval->PB_y[vi], src0[((hsi*15+3)*1+lsi)*1], fp63);
...
fp69 = libint2::fma_plus(inteval->PB_z[vi], src0[((hsi*15+2)*1+lsi)*1], fp70);
target[((hsi*21+5)*1+lsi)*1] = fp69;
LIBINT2_REALTYPE fp74;
fp74 = inteval->PB_z[vi] * src0[((hsi*15+1)*1+lsi)*1];
target[((hsi*21+4)*1+lsi)*1] = fp74;
LIBINT2_REALTYPE fp78;
fp78 = -5.0000000000000000e-01 * src2[((hsi*15+1)*1+lsi)*1];
...
fp75 = libint2::fma_plus(inteval->PB_y[vi], src0[((hsi*15+1)*1+lsi)*1], fp76);
...
fp85 = libint2::fma_plus(-5.0000000000000000e-01, src2[((hsi*15+0)*1+lsi)*1], 0.0000000000000000e+00);
LIBINT2_REALTYPE fp84;
fp84 = inteval->oo2z[vi] * fp85;
LIBINT2_REALTYPE fp87;
LIBINT2_REALTYPE fp83;
fp83 = libint2::fma_plus(inteval->PB_y[vi], src0[((hsi*15+0)*1+lsi)*1], fp84);
