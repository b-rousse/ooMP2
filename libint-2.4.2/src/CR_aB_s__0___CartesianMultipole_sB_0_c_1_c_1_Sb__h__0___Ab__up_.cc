...
fp38 = 0.0000000000000000e+00 + src0[((hsi*8+0)*1+lsi)*1];
...
fp28 = 0.0000000000000000e+00 + src1[((hsi*8+3)*1+lsi)*1];
...
fp23 = libint2::fma_plus(inteval->BO_y[vi], fp25, fp22);
...
fp19 = 0.0000000000000000e+00 + src1[((hsi*8+6)*1+lsi)*1];
...
fp39 = 0.0000000000000000e+00 + src0[((hsi*8+1)*1+lsi)*1];
...
fp42 = 0.0000000000000000e+00 + src0[((hsi*8+4)*1+lsi)*1];
