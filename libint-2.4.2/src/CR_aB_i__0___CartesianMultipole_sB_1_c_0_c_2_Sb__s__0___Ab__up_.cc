...
fp66 = 0.0000000000000000e+00 + src1[((hsi*28+12)*1+lsi)*1];
...
fp65 = 0.0000000000000000e+00 + src1[((hsi*28+16)*1+lsi)*1];
...
fp64 = 0.0000000000000000e+00 + src1[((hsi*28+20)*1+lsi)*1];
