...
fp29 = libint2::fma_plus(inteval->PA_x[vi], target[((hsi*10+2)*1+lsi)*1], fp30);
...
fp18 = libint2::fma_plus(inteval->PA_x[vi], target[((hsi*10+4)*1+lsi)*1], fp19);
...
fp33 = libint2::fma_plus(inteval->PA_x[vi], target[((hsi*10+1)*1+lsi)*1], fp34);
target[((hsi*10+3)*1+lsi)*1] = fp33;
LIBINT2_REALTYPE fp28;
LIBINT2_REALTYPE fp25;
fp25 = libint2::fma_plus(inteval->PA_x[vi], target[((hsi*10+3)*1+lsi)*1], fp26);
...
fp14 = libint2::fma_plus(inteval->PA_x[vi], target[((hsi*10+5)*1+lsi)*1], fp15);
...
fp7 = libint2::fma_plus(inteval->PA_x[vi], target[((hsi*10+6)*1+lsi)*1], fp8);
...
fp3 = libint2::fma_plus(inteval->PA_x[vi], target[((hsi*10+7)*1+lsi)*1], fp4);
