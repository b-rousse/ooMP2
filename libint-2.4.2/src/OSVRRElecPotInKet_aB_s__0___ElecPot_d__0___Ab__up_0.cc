...
fp1 = libint2::fma_minus(inteval->PB_z[vi], src0[((hsi*3+2)*1+lsi)*1], fp2);
...
fp4 = libint2::fma_minus(inteval->PB_z[vi], src0[((hsi*3+1)*1+lsi)*1], fp5);
target[((hsi*6+4)*1+lsi)*1] = fp4;
LIBINT2_REALTYPE fp9;
fp9 = inteval->PC_y[vi] * src1[((hsi*3+1)*1+lsi)*1];
LIBINT2_REALTYPE fp10;
LIBINT2_REALTYPE fp8;
fp8 = libint2::fma_minus(inteval->PB_y[vi], src0[((hsi*3+1)*1+lsi)*1], fp9);
...
fp11 = libint2::fma_minus(inteval->PB_z[vi], src0[((hsi*3+0)*1+lsi)*1], fp12);
target[((hsi*6+2)*1+lsi)*1] = fp11;
LIBINT2_REALTYPE fp15;
fp15 = inteval->PC_y[vi] * src1[((hsi*3+0)*1+lsi)*1];
LIBINT2_REALTYPE fp16;
LIBINT2_REALTYPE fp14;
fp14 = libint2::fma_minus(inteval->PB_y[vi], src0[((hsi*3+0)*1+lsi)*1], fp15);
