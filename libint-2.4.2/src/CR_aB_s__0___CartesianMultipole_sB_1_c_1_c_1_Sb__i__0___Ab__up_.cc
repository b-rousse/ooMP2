...
fp40 = 0.0000000000000000e+00 + src1[((hsi*10+0)*1+lsi)*1];
LIBINT2_REALTYPE fp43;
LIBINT2_REALTYPE fp42;
fp42 = libint2::fma_plus(inteval->BO_y[vi], fp40, fp41);
LIBINT2_REALTYPE fp47;
fp47 = 0.0000000000000000e+00 + src0[((hsi*10+1)*1+lsi)*1];
...
fp31 = 0.0000000000000000e+00 + src1[((hsi*10+4)*1+lsi)*1];
...
fp25 = 0.0000000000000000e+00 + src1[((hsi*10+6)*1+lsi)*1];
...
fp53 = 0.0000000000000000e+00 + src0[((hsi*10+3)*1+lsi)*1];
...
fp59 = 0.0000000000000000e+00 + src0[((hsi*10+5)*1+lsi)*1];
...
fp62 = 0.0000000000000000e+00 + src0[((hsi*10+6)*1+lsi)*1];
...
fp63 = 0.0000000000000000e+00 + src0[((hsi*10+7)*1+lsi)*1];
