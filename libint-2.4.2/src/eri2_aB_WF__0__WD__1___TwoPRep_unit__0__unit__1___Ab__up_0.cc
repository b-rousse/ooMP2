...
extern "C" {
#endif
void eri2_aB_WF__0__WD__1___TwoPRep_unit__0__unit__1___Ab__up_0(const Libint_t* inteval) {
...
eri2_aB_WF__0__WD__1___TwoPRep_unit__0__unit__1___Ab__up_0_prereq(inteval+c, inteval->stack);
}
