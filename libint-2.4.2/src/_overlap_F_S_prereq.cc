...
fp13 = libint2::fma_plus(inteval->PA_z[vi], fp16, fp14);
LIBINT2_REALTYPE fp12;
LIBINT2_REALTYPE fp10;
fp10 = libint2::fma_plus(inteval->PA_z[vi], fp13, fp11);
...
fp21 = libint2::fma_plus(inteval->PA_y[vi], fp24, fp22);
