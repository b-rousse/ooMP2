...
extern "C" {
#endif
void eri3_aB_WD__0__P__1___TwoPRep_unit__0__P__1___Ab__up_0(const Libint_t* inteval) {
...
eri3_aB_WD__0__P__1___TwoPRep_unit__0__P__1___Ab__up_0_prereq(inteval+c, inteval->stack);
}
