...
fp25 = libint2::fma_plus(inteval->PB_y[vi], target[((hsi*10+1)*1+lsi)*1], fp26);
...
fp21 = libint2::fma_plus(inteval->PB_y[vi], target[((hsi*10+2)*1+lsi)*1], fp22);
...
fp17 = libint2::fma_plus(inteval->PB_y[vi], target[((hsi*10+3)*1+lsi)*1], fp18);
...
fp12 = libint2::fma_plus(inteval->PA_y[vi], target[((hsi*10+1)*1+lsi)*1], fp13);
...
fp8 = libint2::fma_plus(inteval->PA_y[vi], target[((hsi*10+2)*1+lsi)*1], fp9);
...
fp4 = libint2::fma_plus(inteval->PA_y[vi], target[((hsi*10+3)*1+lsi)*1], fp5);
