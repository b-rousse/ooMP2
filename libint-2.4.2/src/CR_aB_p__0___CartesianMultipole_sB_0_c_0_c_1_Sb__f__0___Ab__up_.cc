...
fp34 = 0.0000000000000000e+00 + src0[((hsi*10+0)*1+lsi)*1];
...
fp32 = 0.0000000000000000e+00 + src1[((hsi*10+1)*1+lsi)*1];
...
fp31 = 0.0000000000000000e+00 + src1[((hsi*10+2)*1+lsi)*1];
...
fp13 = 0.0000000000000000e+00 + src2[((hsi*10+4)*1+lsi)*1];
...
fp26 = 0.0000000000000000e+00 + src1[((hsi*10+8)*1+lsi)*1];
...
fp40 = 0.0000000000000000e+00 + src0[((hsi*10+7)*1+lsi)*1];
