...
fp59 = libint2::fma_plus(inteval->BO_y[vi], fp57, fp58);
...
fp55 = libint2::fma_plus(inteval->BO_y[vi], fp58, fp54);
...
fp51 = 0.0000000000000000e+00 + src1[((hsi*14+10)*1+lsi)*1];
...
fp48 = 0.0000000000000000e+00 + src1[((hsi*14+11)*1+lsi)*1];
