...
fp24 = libint2::fma_plus(inteval->PB_z[vi], src0[((hsi*6+2)*1+lsi)*1], fp25);
...
fp28 = libint2::fma_plus(inteval->PB_z[vi], src0[((hsi*6+1)*1+lsi)*1], fp29);
...
fp32 = libint2::fma_plus(inteval->PB_y[vi], src0[((hsi*6+1)*1+lsi)*1], fp33);
...
fp40 = libint2::fma_plus(inteval->PB_z[vi], src0[((hsi*6+0)*1+lsi)*1], fp41);
...
fp44 = libint2::fma_plus(inteval->PB_y[vi], src0[((hsi*6+0)*1+lsi)*1], fp45);
