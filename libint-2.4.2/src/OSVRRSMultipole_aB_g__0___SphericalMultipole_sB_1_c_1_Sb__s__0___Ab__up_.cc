...
fp21 = libint2::fma_plus(inteval->PA_z[vi], src0[((hsi*10+5)*1+lsi)*1], fp22);
...
fp26 = libint2::fma_plus(inteval->PA_z[vi], src0[((hsi*10+4)*1+lsi)*1], fp27);
target[((hsi*15+8)*1+lsi)*1] = fp26;
LIBINT2_REALTYPE fp31;
fp31 = inteval->PA_z[vi] * src0[((hsi*10+3)*1+lsi)*1];
...
fp32 = libint2::fma_plus(inteval->PA_y[vi], src0[((hsi*10+3)*1+lsi)*1], fp33);
...
fp42 = inteval->PA_z[vi] * src0[((hsi*10+1)*1+lsi)*1];
...
fp43 = libint2::fma_plus(inteval->PA_y[vi], src0[((hsi*10+1)*1+lsi)*1], fp44);
target[((hsi*15+3)*1+lsi)*1] = fp43;
LIBINT2_REALTYPE fp48;
fp48 = inteval->PA_z[vi] * src0[((hsi*10+0)*1+lsi)*1];
...
fp54 = libint2::fma_plus(3.0000000000000000e+00, src1[((hsi*6+0)*1+lsi)*1], 0.0000000000000000e+00);
...
fp50 = libint2::fma_plus(inteval->PA_x[vi], src0[((hsi*10+0)*1+lsi)*1], fp51);
