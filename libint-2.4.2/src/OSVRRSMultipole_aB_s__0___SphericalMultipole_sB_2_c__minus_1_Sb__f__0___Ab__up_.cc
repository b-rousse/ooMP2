...
fp27 = libint2::fma_plus(inteval->PB_z[vi], src0[((hsi*6+1)*1+lsi)*1], fp28);
...
fp31 = libint2::fma_plus(inteval->PB_y[vi], src0[((hsi*6+1)*1+lsi)*1], fp32);
...
fp38 = libint2::fma_plus(inteval->PB_z[vi], src0[((hsi*6+0)*1+lsi)*1], fp39);
...
fp42 = libint2::fma_plus(inteval->PB_y[vi], src0[((hsi*6+0)*1+lsi)*1], fp43);
