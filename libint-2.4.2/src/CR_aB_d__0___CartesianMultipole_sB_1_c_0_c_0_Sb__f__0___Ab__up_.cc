...
fp24 = 0.0000000000000000e+00 + src0[((hsi*15+0)*1+lsi)*1];
...
fp21 = 0.0000000000000000e+00 + src1[((hsi*15+2)*1+lsi)*1];
...
fp20 = 0.0000000000000000e+00 + src1[((hsi*15+3)*1+lsi)*1];
...
fp30 = 0.0000000000000000e+00 + src0[((hsi*15+2)*1+lsi)*1];
...
fp43 = 0.0000000000000000e+00 + src0[((hsi*15+7)*1+lsi)*1];
...
fp53 = 0.0000000000000000e+00 + src0[((hsi*15+11)*1+lsi)*1];
...
fp56 = 0.0000000000000000e+00 + src0[((hsi*15+12)*1+lsi)*1];
