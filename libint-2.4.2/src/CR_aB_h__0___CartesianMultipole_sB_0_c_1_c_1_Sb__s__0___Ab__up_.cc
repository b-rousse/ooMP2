...
fp41 = 0.0000000000000000e+00 + src1[((hsi*18+4)*1+lsi)*1];
...
fp28 = 0.0000000000000000e+00 + src1[((hsi*18+12)*1+lsi)*1];
...
fp25 = 0.0000000000000000e+00 + src1[((hsi*18+16)*1+lsi)*1];
...
fp49 = 0.0000000000000000e+00 + src0[((hsi*18+3)*1+lsi)*1];
...
fp50 = 0.0000000000000000e+00 + src0[((hsi*18+6)*1+lsi)*1];
...
fp51 = 0.0000000000000000e+00 + src0[((hsi*18+9)*1+lsi)*1];
